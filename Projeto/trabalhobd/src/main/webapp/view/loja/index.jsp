      ...
      <div class="container">
        <div class="text-center div_inserir_excluir">
          ...
          <button
            ...
            data-toggle="modal"
            data-target=".modal_excluir_websites"
          >
            Excluir múltiplos sites
          </button>
        </div>
        <form
          class="form_excluir_websites"
          action="${pageContext.servletContext.contextPath}/loja/delete"
          method="POST"
        >
          <table class="table table-striped">
            ...
            <c:forEach var="loja" items="${requestScope.lojaList}">
              <tr>
                <td>
                  <a
                    class="link_visualizar_website"
                    href="#"
                    data-href="${pageContext.servletContext.contextPath}/loja/read?nome=${loja.nome}"
                  >
                ...
                <td class="text-center">
                  <a
                    class="btn btn-default link_excluir_website"
                    href="#"
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <p>
                    Tem certeza de que deseja excluir os sites selecionados?
                  </p>
                </div>
                <div class="modal-footer">
                  <button
                    class="btn btn-danger button_confirmacao_excluir_websites"
                    type="button"
                  >
                    Sim
                  </button>
        ...
        <div class="modal fade modal_excluir_website">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <a class="btn btn-danger link_confirmacao_excluir_website"
                  >Sim</a
                >
                <button
                  class="btn btn-primary"
